...
public class DistressSignal extends AdventOfCodeSolver {

  public DistressSignal() throws IOException {
    this("input.txt");
  }

  public DistressSignal(String resourceFileName) throws IOException {
  ...
  public static void main(String[] args) throws IOException {
    ...
    distressSignal.printAnswers();
    System.out.println();
    distressSignal.printTimings();
  }
  ...
  public void solve() {
    ...
    addAnswer("Sum of correctly ordered indices", sumOfCorrectlyPairedIndices);
    ...
    addAnswer("Decoder key", decoderKey);
  }
